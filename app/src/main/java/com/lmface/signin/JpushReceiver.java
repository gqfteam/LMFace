...
public class JpushReceiver extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
     ...
     if (intent.getAction().equals(JPushInterface.ACTION_MESSAGE_RECEIVED)){
         ...
         SharedPreferences preferences=context.getSharedPreferences("jpush_message",Context.MODE_PRIVATE);
...
*/        }
        ...
        Log.i("Jpush_TAG","跳转到签到");
         ...
         Log.i("Jpush_Tag","message222-------"+message);
            Intent i = new Intent(context,NowNeedSignListActivity.class);//自定义打开的界面
       /*  if(message!=null){
