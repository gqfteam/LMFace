...
import com.lmface.util.in.srain.cube.views.ptr.util.PtrCLog;
...
public class PtrFrameLayout extends ViewGroup {
	...
	public void setIsScroll(boolean is){
		isScroll=is;
	}
	@Override
	public boolean dispatchTouchEvent(MotionEvent e) {
		
		if (!isEnabled() || mContent == null || mHeaderView == null || isScroll==false) {
