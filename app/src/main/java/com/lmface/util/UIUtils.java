...
public class UIUtils {
	...
	public static Context getContext() {
		return LMFaceApplication.getContext();
	}

	public static Thread getMainThread() {
		return LMFaceApplication.getMainThread();
	}

	public static long getMainThreadId() {
		return LMFaceApplication.getMainThreadId();
	}
	...
	public static Handler getHandler() {
		return LMFaceApplication.getMainThreadHandler();
	}
...
//		}
		if (toast == null) {
			toast = Toast.makeText(LMFaceApplication.getContext(), str, Toast.LENGTH_SHORT);
		}
		toast.setText(str);
		toast.show();
	}
